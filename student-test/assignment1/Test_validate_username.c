...
void test_validate_my_username()
{
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(hardcoded_username, conf_username, "The username from my_username() does not match the username read from conf/username.txt");
